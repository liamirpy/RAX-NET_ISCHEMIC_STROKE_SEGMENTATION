...
axial_saved_model_folds='../../Model_Comparison/X_net//axial'
sagittal_saved_model_folds='../../Model_Comparison/X_net//sagittal'
coronal_saved_model_folds='../../Model_Comparison/X_net//coronal'
    ...
    for fold in range(1,number_of_folds+1):
        ...
        if plane == sagittal_fold_csv_directory:
            ...
            model=load_model(f'{sagittal_saved_model_folds}/fold_{fold}/sagittal_fold_{fold}.h5'
                             ,custom_objects={'get_loss':stats.get_loss,'dice_coef': stats.dice_coef,'precision':stats.precision,'recall':stats.recall,'hausdorff_distance':stats.hausdorff_distance})
        ...
        if plane == coronal_fold_csv_directory:
            ...
            model=load_model(f'{coronal_saved_model_folds}/fold_{fold}/coronal_fold_{fold}.h5',custom_objects={  
                                         ...
                                         'get_loss':stats.get_loss,'dice_coef': stats.dice_coef,'precision':stats.precision,'recall':stats.recall,'hausdorff_distance':stats.hausdorff_distance})
