...
class load_data:
    ...
    def axial_read_and_load_data_in_numpy(self,train_csv,validation_csv,data_directory,fold):
        ...
        self.train_data_mri=np.zeros((number_of_batch*self.batch_size,208,240,1),dtype=np.float32)

        self.train_data_mask=np.zeros((number_of_batch*self.batch_size,208,240,1),dtype=np.float32)
        ...
        for batch in range(1,number_of_batch+1):
            ...
            for index, row in batch_data.iterrows():
                ...
                self.train_data_mri[row_num,6:6+197,3:3+233,0] = mri_numpy
                ...
                self.train_data_mask[row_num,6:6+197,3:3+233,0] = mask_numpy
        ...
        for batch in range(1,number_of_batch+1):
            ...
            for index, row in batch_data.iterrows():
                ...
                self.validation_data_mri[row_num,6:6+197,3:3+233,0] = mri_numpy
                ...
                self.validation_data_mask[row_num,6:6+197,3:3+233,0] = mask_numpy
    ...
    def sagittal_read_and_load_data_in_numpy(self,train_csv,validation_csv,data_directory,fold):
        ...
        for batch in range(1,number_of_batch+1):
            ...
            for index, row in batch_data.iterrows():
                ...
                self.train_data_mri[row_num,3:3+233,9:9+189,0] = mri_numpy
                ...
                self.train_data_mask[row_num,3:3+233,9:9+189,0] = mask_numpy
        ...
        for batch in range(1,number_of_batch+1):
            ...
            for index, row in batch_data.iterrows():
                ...
                self.validation_data_mri[row_num,3:3+233,9:9+189,0] = mri_numpy
                ...
                self.validation_data_mask[row_num,3:3+233,9:9+189,0] = mask_numpy
    ...
    def coronal_read_and_load_data_in_numpy(self,train_csv,validation_csv,data_directory,fold):
        ...
        for batch in range(1,number_of_batch+1):
            ...
            for index, row in batch_data.iterrows():
                ...
                self.train_data_mri[row_num,5:5+197,9:9+189,0] = mri_numpy
                ...
                self.train_data_mask[row_num,5:5+197,9:9+189,0] = mask_numpy
        ...
        for batch in range(1,number_of_batch+1):
            ...
            for index, row in batch_data.iterrows():
                ...
                self.validation_data_mri[row_num,5:5+197,9:9+189,0] = mri_numpy
                ...
                self.validation_data_mask[row_num,5:5+197,9:9+189,0] = mask_numpy
