...
coronal_bins=[0,500,1000,1500,2000,2500,3000,3500,4000,float('inf')]



number_of_coronal_bins=9


def put_data_to_bins_coronal():


    csv_file_path = 'lesion_coronal_distribution_train_dataset.csv'

    data_bins_coronal={
        
                'data_bin_1':[],'data_bin_2':[],'data_bin_3':[],'data_bin_4':[],'data_bin_5':[],
                'data_bin_6':[],'data_bin_7':[],'data_bin_8':[],'data_bin_9':[]
    ...
    # Iterate over the rows and count them
        ...
        for row in reader:
            ...
            if coronal_bins[0] < sum_voxel <= coronal_bins[1]:
                ...
                data_bins_coronal['data_bin_1'].append(data_bins)



            elif coronal_bins[1] < sum_voxel <= coronal_bins[2]:
                ...
                data_bins_coronal['data_bin_2'].append(data_bins)


            elif coronal_bins[2] < sum_voxel <= coronal_bins[3]:
                ...
                data_bins_coronal['data_bin_3'].append(data_bins)


            elif coronal_bins[3]< sum_voxel <=coronal_bins[4]:
                ...
                data_bins_coronal['data_bin_5'].append(data_bins)


            elif coronal_bins[5] < sum_voxel <= coronal_bins[6]:
                ...
                data_bins_coronal['data_bin_6'].append(data_bins)




            elif coronal_bins[6] < sum_voxel <= coronal_bins[7]:
                ...
                data_bins_coronal['data_bin_7'].append(data_bins)





            elif coronal_bins[7] < sum_voxel <= coronal_bins[8]:
                ...
                data_bins_coronal['data_bin_8'].append(data_bins)
                ...
                data_bins_coronal['data_bin_9'].append(data_bins)
    

    return num_rows,data_bins_coronal


number_of_coronal_slice,data_bins_coronal=put_data_to_bins_coronal()



print(number_of_coronal_slice)
...
number_of_extra_slice=str(number_of_coronal_slice/10)[-1]
...
bin_allowness_for_each_fold={
                ...
                'data_bin_1':int(len(data_bins_coronal['data_bin_1'])/5),     'data_bin_2':int(len(data_bins_coronal['data_bin_2'])/5) ,       'data_bin_3':int(len(data_bins_coronal['data_bin_3'])/5),      'data_bin_4':int(len(data_bins_coronal['data_bin_4'])/5),  
                                    'data_bin_5':int(len(data_bins_coronal['data_bin_5'])/5),              'data_bin_6':int(len(data_bins_coronal['data_bin_6'])/5),        
                                      'data_bin_7':int(len(data_bins_coronal['data_bin_7'])/5),         'data_bin_8':int(len(data_bins_coronal['data_bin_8'])/5),  
                                                    'data_bin_9':int(len(data_bins_coronal['data_bin_9'])/5)
...
size_each_fold=int(len(data_bins_coronal['data_bin_1'])/5)+ int(len(data_bins_coronal['data_bin_2'])/5)+ int(len(data_bins_coronal['data_bin_3'])/5)+ int(len(data_bins_coronal['data_bin_4'])/5) \
                + int(len(data_bins_coronal['data_bin_5'])/5)+ int(len(data_bins_coronal['data_bin_6'])/5)+ \
                int(len(data_bins_coronal['data_bin_7'])/5)+ int(len(data_bins_coronal['data_bin_8'])/5)+ int(len(data_bins_coronal['data_bin_9'])/5)
...
def find_empty_fold():
    ...
    for fold in range(1,number_of_fold+1):
        ...
        if len(coronal_folds[f'axial_fold_{fold}']) < size_each_fold:
            empty_fold=fold
            break
...
sum_fold=len(coronal_folds['axial_fold_1'])+len(coronal_folds['axial_fold_2'])+len(coronal_folds['axial_fold_3'])+len(coronal_folds['axial_fold_4'])+len(coronal_folds['axial_fold_5'])
...
while( sum_fold < size_each_fold * 5 ): 
    ...
    for bins_intialization in range(1,len_coronal_bin+1):


        len_bin_n=len(data_bins_coronal[f'data_bin_{bins_intialization}'])
        ...
        while(len_bin_n > 0): 
            ...
            len_bin_n_start=len(data_bins_coronal[f'data_bin_{bins_intialization}'])



            initial_random = random.choice(data_bins_coronal[f'data_bin_{bins_intialization}'])
            ...
            for bins_searching in range(1,len_coronal_bin+1):

                d=data_bins_coronal[f'data_bin_{bins_searching}']
                ...
                for entry in desired_entries:
                    ...
                    if (bin_picked_for_each_fold[f'data_bin_{bins_searching}'][f'fold_{empty_fold}'] ) < bin_allowness_for_each_fold[f'data_bin_{bins_searching}']:
                        ...
                        coronal_folds[f'axial_fold_{empty_fold}'].append(item)


                        data_bins_coronal[f'data_bin_{bins_searching}'].remove(item)
...
for fo in range(1,6):
    ...
    axial_slices=coronal_folds[f'axial_fold_{fo}']
    # CSV file path
    csv_file_path = f'./coronal/lesion_distribution_coronal_fold_{fo}.csv'
