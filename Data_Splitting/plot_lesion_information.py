...
class plot_lesion_information:
    ...
    def lesion_information_in_3D_Training(self,csv_file,ranges):
        ...
        plt.xlabel('Lesion Size Distribution in 80 Percent of 655 3D MRI Subjects',fontsize=20)
    ...
    def lesion_information_in_3D_Fusion(self,csv_file,ranges):
        ...
        # Set the labels for the axes
        plt.xlabel('Lesion Size Distribution in 20 Percent of 655 3D MRI Subjects',fontsize=20)
        plt.ylabel('volume (10 ^3) Voxels', fontsize=20)
        ...
        plt.savefig('Lesion_information_in_20_Percent_of_665_3D_Subjects.png', dpi=400)
    ...
    def lesion_information_in_axial(self,csv_file,ranges):
        ...
        # Set the labels for the axes
        plt.xlabel('Lesion Size Distribution in Axial Plane of 80 Percent of 655 3D MRI Subjects',fontsize=20)
        ...
        plt.savefig('Lesion_information_in_Axial_Plane_of_80_Percent_of_665_3D_Subjects.png', dpi=400)
    ...
    def lesion_information_in_sagittal(self,csv_file,ranges):
        ...
        # Set the labels for the axes
        plt.xlabel('Lesion Size Distribution in Sagittal Plane of 80 Percent of 655 3D MRI Subjects',fontsize=20)
        plt.ylabel('volume Pixels', fontsize=20)
        ...
        plt.savefig('Lesion_information_in_Sagittal_Plane_in_80_Percent_of_665_3D_Subjects.png', dpi=400)
    ...
    def lesion_information_in_coronal(self,csv_file,ranges):
        ...
        # Set the labels for the axes
        plt.xlabel('Lesion Size Distribution in Coronal Plane of 80 Percent of 655 3D MRI Subjects',fontsize=20)
        plt.ylabel('volume Pixels', fontsize=20)
        ...
        plt.savefig('Lesion_information_in_Coronal_Plane_of_80_Percent_of_665_3D_Subjects.png', dpi=400)
...
lesion_3D_subject_csv='./CSV/Lesion_information_for_80_percent_of_3D_MRI_Subject.csv'


plot=plot_lesion_information()

plot.lesion_information_in_3D_Training(lesion_3D_subject_csv,ranges_in_3D_Subject)





lesion_3D_subject_csv='./CSV/Lesion_information_for_20_percent_of_3D_MRI_Subject.csv'


plot=plot_lesion_information()

plot.lesion_information_in_3D_Fusion(lesion_3D_subject_csv,ranges_in_3D_Subject)





axial_csv='./CSV/Axial_Lesion_information_for_80_percent_of_3D_MRI_Subject.csv'
...
sagittal_csv='./CSV/Sagittal_Lesion_information_for_80_percent_of_3D_MRI_Subject.csv'
...
coronal_csv='./CSV/Coronal_Lesion_information_for_80_percent_of_3D_MRI_Subject.csv'
