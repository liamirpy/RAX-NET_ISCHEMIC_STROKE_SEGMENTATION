...
# Load the model
model = load_model('dice.h5',custom_objects={'DiceCoefLoss':stats.DiceCoefLoss,'dice_coef': stats.dice_coef,'precision':stats.precision,'recall':stats.recall,'hausdorff_distance':stats.hausdorff_distance})
...
with open('results_dice.csv', 'w', newline='') as csvfile:
