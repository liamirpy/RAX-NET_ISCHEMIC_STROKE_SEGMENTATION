...
from model import xception_unet
...
def parameters_and_train(
    ...
    # LOAD MODEL
    model = xception_unet(image_size)
...
# python3 train.py --image_size 208 240 --num_classes 1 --folder_directory ../../Data_Preparation/Axial/fold_3 --train_mri train_data_mri_fold_3.npy --train_mask train_data_mask_fold_3.npy --validation_mri validation_data_mri_fold_3.npy --validation_mask validation_data_mask_fold_3.npy  --metrics_names precision recall  hausdorff_distance --epochs 150 --patients 20 --checkpoint_path ./ --checkpoint_name lo
