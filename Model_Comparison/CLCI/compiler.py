...
class ModelTrainer:
    ...
    def train(self):
        ...
        self.model.fit(self.train_data_mri,self.train_data_mask,validation_data=(self.validation_data_mri,self.validation_data_mask),shuffle=True,batch_size=16,epochs=self.num_epochs,callbacks=[callbacks,csv_logger,time_callback])
